    ...
    <div class="collapse navbar-collapse" id="navbarNav">
        <ul id="navDropdown" class="navbar-nav d-flex ml-auto justify-content-between mr-4">
            <li class="nav-item dropdown <?php if ($main_nav == "wir-sind") echo "active"; ?>">
                <a class="nav-link" href="/we-are" id="dropdown84f35faa-9b26-4b75-ba96-dbfba39478a7" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">We are</a>
            ...
            <li class="nav-item dropdown <?php if ($main_nav == "wir-machen") echo "active"; ?>">
                <a class="nav-link" href="/wir-machen" id="dropdownbb6dcda1-4dbd-47b8-b4a3-9500d0b6be9a" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Wir machen</a>
            ...
            <li class="nav-item dropdown <?php if ($main_nav == "wir-bieten") echo "active"; ?>">
                <a class="nav-link" href="/wir-bieten" id="dropdown9d393296-614d-42f6-8a8b-432ac2471045" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Wir bieten</a>
            ...
            <li class="nav-item dropdown <?php if ($main_nav == "finden-sie-uns") echo "active"; ?>">
                <a class="nav-link" href="/finden-sie-uns" id="dropdowndca789c4-2bf0-4a6c-bf8b-b75ba88212f7" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Finden Sie uns</a>
...
-->
            <li class="nav-item dropdown ">
                <a class="nav-link" href="/change-language" id="dropdown7cee16a2-631d-4787-b68e-8989b9ab216c" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Change Language</a>
